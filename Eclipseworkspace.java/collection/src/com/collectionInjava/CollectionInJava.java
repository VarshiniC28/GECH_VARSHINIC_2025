...
public class CollectionInJava {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Drawbacks of Array:
		 * 1. Fixed size -> cant change the size of arrya once declared.
		 * 2. Same data type elements cant store multi datatypes.
		 ...
		 * 3. type casting - To print the elemen in arrays - no need to type cast. 
		 * */
		
		char [] arr = new char[2]; // since we have already mentioned dattatype int so even if we give another datatype value it automatically type casts to int , if its char and we give nint , automatically it changes as char
		arr[0] = 12;
